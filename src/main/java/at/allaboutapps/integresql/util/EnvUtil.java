...
/**
 * Utility class for retrieving environment variables with default values and type conversion.
 */
public final class EnvUtil {
     ...
     * Note: Unlike some interpretations, this returns the value even if it's an empty string,
     ...
     * If the variable is not set or cannot be parsed as an integer, the default value is returned.
     *
     * @param key        The name of the environment variable.
     ...
     * Any other value (or if the variable is unset) results in the default value being returned.
     *
     * @param key        The name of the environment variable.
    ...
    public static boolean getEnvAsBool(String key, boolean defaultVal) {
        ...
        if (strVal != null) {
            ...
            switch (lowerVal) {
                case "1": case "t": case "true":
                    return true;
                case "0": case "f": case "false":
                    return false;
                default:
